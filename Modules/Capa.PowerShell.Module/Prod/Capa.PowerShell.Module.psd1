#
# Module manifest for module 'Capa.PowerShell.Module'
#
...
RequiredModules = @(@{ModuleName = 'Capa.PowerShell.Module.PowerPack'; ModuleVersion = '1.15.1'; }, 
               @{ModuleName = 'Capa.PowerShell.Module.SDK'; ModuleVersion = '1.15.1'; })
