...
```
Invite-CapaUnitToVppProgram [-CapaSDK] <psobject> [-VppProgramID] <int> [-UnitID] <int>
 [-UserFullName] <string> [-UserEmailName] <string> [-UserDescription] <string> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
