@{
	...
	# this module
	RequiredModules        = @(@{ ModuleName = 'Capa.PowerShell.Module.PowerPack.Job'; RequiredVersion = '1.7.0'; },
		@{ ModuleName = 'Capa.PowerShell.Module.PowerPack'; RequiredVersion = '1.7.0'; })
