...
title: Enable-CapaPackageSchedule
---
...
```
Enable-CapaPackageSchedule [-CapaSDK] <Object> [-PackageName] <string> [-PackageVersion] <string>
 [-PackageType] <string> [-WhatIf] [-Confirm] [<CommonParameters>]
```
