@{
    ...
    # this module
    RequiredModules        = @(@{ ModuleName = 'Capa.PowerShell.Module.PowerPack.File'; RequiredVersion = '1.10.0'; },
        @{ ModuleName = 'Capa.PowerShell.Module.PowerPack.Ini'; RequiredVersion = '1.10.0'; },
        @{ ModuleName = 'Capa.PowerShell.Module.PowerPack.Job'; RequiredVersion = '1.10.0'; },
        @{ ModuleName = 'Capa.PowerShell.Module.PowerPack.Log'; RequiredVersion = '1.10.0'; },
        @{ ModuleName = 'Capa.PowerShell.Module.PowerPack.MSI'; RequiredVersion = '1.10.0'; },
        @{ ModuleName = 'Capa.PowerShell.Module.PowerPack.Reg'; RequiredVersion = '1.10.0'; },
