@{
	...
	# this module
	RequiredModules        = @(@{ ModuleName = 'Capa.PowerShell.Module.PowerPack.Job'; RequiredVersion = '1.9.0'; },
		@{ ModuleName = 'Capa.PowerShell.Module.PowerPack'; RequiredVersion = '1.9.0'; })
