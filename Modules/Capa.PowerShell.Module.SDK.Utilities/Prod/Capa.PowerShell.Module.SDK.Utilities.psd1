#
# Module manifest for module 'Capa.PowerShell.Module.SDK.Utilities'
#
...
FunctionsToExport = 'Create-CapaADGroup', 'Get-CapaLog', 'Get-CapaReinstallStatus', 
               'Move-CapaDeviceToPoint', 'Restart-CapaAgent', 'Set-CapaWakeOnLAN'
