...
```
Get-CapaUnitWSUSGroup [-CapaSDK] <psobject> [-UnitName] <string> [-UnitType] <string>
 [<CommonParameters>]
```
...
Get-CapaUnitWSUSGroup -CapaSDK $CapaSDK -UnitName 'PC-01' -UnitType Computer
