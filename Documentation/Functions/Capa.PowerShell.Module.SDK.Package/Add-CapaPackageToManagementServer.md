...
title: Add-CapaPackageToManagementServer
---
...
```
Add-CapaPackageToManagementServer [-CapaSDK] <Object> [-PackageName] <string>
 [-PackageVersion] <string> [-PackageType] <string> [-ServerName] <string> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
