...
```
Add-CCSADDomainLocalSecurityGroup [-GroupName] <string[]> -Domain <string> -Url <string>
...
Add-CCSADDomainLocalSecurityGroup -GroupName "TestGroup" -Description "Test Description" -DomainOUPath "OU=Groups,DC=example,DC=com" -Domain "example.com" -Url "https://example.com/CCSWebservice/CCS.asmx" -CCSCredential $Credential
