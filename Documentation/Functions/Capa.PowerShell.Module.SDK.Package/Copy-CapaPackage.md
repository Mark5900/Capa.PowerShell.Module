...
```
Copy-CapaPackage [-CapaSDK] <Object> [-PackageName] <string> [-PackageVersion] <string>
 [-PackageType] <string> [-NewName] <string> [-NewVersion] <string> [<CommonParameters>]
```
