@{
	...
	# this module
	RequiredModules        = @(@{ ModuleName = 'Capa.PowerShell.Module.PowerPack.Job'; RequiredVersion = '1.8.2'; },
		@{ ModuleName = 'Capa.PowerShell.Module.PowerPack'; RequiredVersion = '1.8.2'; })
