BeforeAll {
	...
	$TestCode = '  $bStatus = Add-PpCMSComputerToStaticGroup -Group "Test"
	$cs.Job_WriteLog("Add-PpCMSComputerToStaticGroup: bStatus = $bStatus")
	if ($bStatus){
		$cs.Job_WriteLog("Add-PpCMSComputerToStaticGroup: Package added to unit")
	} else {
		$cs.Job_WriteLog("Add-PpCMSComputerToStaticGroup: Package not added to unit")
	}'
...
Describe 'Add-PpCMSComputerToDepartmentGroup' {
	...
	It 'The log should contain the right text' {
		...
		$LogContent | Should -Match 'Add-PpCMSComputerToStaticGroup: bStatus = True'
		$LogContent | Should -Match 'Add-PpCMSComputerToStaticGroup: Package added to unit'
	}
}
AfterAll {
	...
	Remove-CapaGroup -CapaSDK $oCMSProd -GroupName 'Test' -GroupType 'Static' -UnitType 'Computer'
