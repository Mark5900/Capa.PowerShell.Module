...
### [Confirm-CCSADUser](Confirm-CCSADUser.md)

Validates a user's credentials against Active Directory.

### [Create-CCSADSecurityGroupsForShares](Create-CCSADSecurityGroupsForShares.md)
...
### [Invoke-CCSErrorHandling](Invoke-CCSErrorHandling.md)
...
### [Move-CCSADComputer](Move-CCSADComputer.md)
...
### [Remove-CCSADComputerFromSecurityGroup](Remove-CCSADComputerFromSecurityGroup.md)

Removes a computer from a security group in Active Directory using the CCS Web Service.

### [Remove-CCSADUserFromSecurityGroup](Remove-CCSADUserFromSecurityGroup.md)

Removes a user from a security group in Active Directory using the CCS Web Service.

### [Test-CCSADIsUserMemberOfGroup](Test-CCSADIsUserMemberOfGroup.md)
