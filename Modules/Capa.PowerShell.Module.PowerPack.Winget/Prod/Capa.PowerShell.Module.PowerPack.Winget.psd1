#
# Module manifest for module 'Capa.PowerShell.Module.PowerPack.Winget'
#
...
RequiredModules = @(@{ModuleName = 'Capa.PowerShell.Module.PowerPack.Job'; RequiredVersion = '1.13.0'; }, 
