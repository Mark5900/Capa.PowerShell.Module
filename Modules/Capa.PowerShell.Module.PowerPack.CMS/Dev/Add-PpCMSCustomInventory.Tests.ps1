...
Describe 'Add-PpCMSCustomInventory' {
	...
	It 'The custom inventory should contain the right text' {
		$CustomInventory = Get-CapaCustomInventoryForUnit -CapaSDK $oCMSProd -UnitName $env:COMPUTERNAME -UnitType 'Computer' | Where-Object { $_.Category -eq 'MyCategory' -and $_.Entry -eq 'MyEntry' }
