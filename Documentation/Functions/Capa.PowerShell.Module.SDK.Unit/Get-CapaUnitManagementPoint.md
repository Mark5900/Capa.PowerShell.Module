...
title: Get-CapaUnitManagementPoint
---
...
```
Get-CapaUnitManagementPoint [-CapaSDK] <psobject> [-UnitName] <string> [-UnitType] <string>
 [<CommonParameters>]
```
...
Get-CapaUnitManagementPoint -CapaSDK $CapaSDK -UnitName 'PC-01' -UnitType Computer
